#!/usr/bin/env bash
# Convert all images in a folder to JPEG (quality 95), resizing so the
# shortest edge is 1536px (never upscaling smaller images).
# Output goes to <folder>_jpeg next to the input.
#
# Usage: ./resize_to_jpeg.sh <folder>
